...
class Word(Base):
    ...
    # word_meaning: VARCHAR(300), NOT NULL
    word_meaning = Column(String(300), nullable=False)

    # word_example: VARCHAR(500), NULL
    word_example = Column(String(500), nullable=True)
